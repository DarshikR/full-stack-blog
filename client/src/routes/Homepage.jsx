        ...
        <div className="mt-4 flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
                ...
                <div className="">
                    ...
                    <p className="mt-8 text-md md:text-xl">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Doloremque animi nisi nemo.</p>
                </div>
                {/* animated button */}
            ...
            {/* Post List */}
            <div className="">
                <h1 className="my-8 text-2xl to-gray-600">Recent Post</h1>
                <PostList />
            </div>
        </div>
    )
